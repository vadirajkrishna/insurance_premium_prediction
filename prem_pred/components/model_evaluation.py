from prem_pred.entity.config_entity import ModelEvaluationConfig
from prem_pred.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
# from sklearn.metrics import f1_score
from sklearn.metrics import r2_score
from prem_pred.exception import InsPremException
from prem_pred.constants import TARGET_COLUMN, CURRENT_YEAR
...
# from prem_pred.entity.estimator import TargetValueMapping
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[PremPredEstimator]:
        """
        ...
        try:
            ...
            prempred_estimator = PremPredEstimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if prempred_estimator.is_model_present(model_path=model_path):
                return prempred_estimator
            return None
        except Exception as e:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            # test_df['company_age'] = CURRENT_YEAR-test_df['yr_of_estab']         # This is not relevant for us
            x, y = test_df.drop(TARGET_COLUMN, axis=1), test_df[TARGET_COLUMN]
            # y = y.replace(                                                       # This is not relevant for us
