...
# from sklearn.metrics import accuracy_score, f1_score, precision_score, recall_score # This is not relevannt for this project
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            # The below metrics are for classification, its not relevant for us
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            prempred_model = PremPredModel(preprocessing_object=preprocessing_obj,
                                       trained_model_object=best_model_detail.best_model)
            logging.info("Created prempred model object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, prempred_model)
